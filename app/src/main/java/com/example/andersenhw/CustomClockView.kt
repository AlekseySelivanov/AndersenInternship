...
class CustomClockView @JvmOverloads constructor(
    ...
    init {
        ...
        try {
            hourHandColor = ta.getColor(R.styleable.CustomClockView_hourHandColor, Color.BLACK)
            minuteHandColor =
                ta.getColor(R.styleable.CustomClockView_minuteHandColor, Color.BLACK)
            secondHandColor = ta.getColor(R.styleable.CustomClockView_secondHandColor, Color.RED)
            hourHandSize =
                ta.getDimension(R.styleable.CustomClockView_secondHandColor, HOUR_HAND_WIDTH)
            minuteHandSize =
                ta.getDimension(R.styleable.CustomClockView_secondHandColor, MINUTE_HAND_WIDTH)
            secondHandSize =
                ta.getDimension(R.styleable.CustomClockView_secondHandColor, SECOND_HAND_WIDTH)
        } finally {
            ta.recycle()
        }
